...
กฎนี้อนุญาตเฉพาะบัญชี Google ให้แก้โปรไฟล์ ความคืบหน้า ตำแหน่ง ข้อความใกล้ตัว สัญญาณจับคู่ Voice และข้อมูลสมาชิก Raid ของ UID ตนเอง บัญชี Anonymous ถูกปฏิเสธ ผู้ที่ไม่ได้อยู่ในห้องอ่านข้อมูล Raid ไม่ได้ การโจมตีหนึ่งครั้งถูกจำกัดไม่เกิน 40 HP และอีโมตใช้ได้เฉพาะรายการที่ระบบกำหนด อีเมลไม่ถูกเก็บใน Realtime Database และไม่แสดงแก่ผู้เล่นอื่น ตำแหน่งออนไลน์รองรับครบ 4 โลก ได้แก่ ศูนย์กลาง ป่าฝึก นครกฎหมาย และมหานครอนาคต ข้อความจำกัด 80 ตัวอักษรและเก็บล่าสุดเพียงหนึ่งข้อความต่อผู้เล่นต่อโซน
...
- Rules รุ่น `2026-07-18.6` เพิ่ม WebRTC signaling แบบ private inbox, Voice presence และคงข้อความตามระยะ/Test Admin พร้อมโซนออนไลน์ครบ 4 โลก
