...
- Rules รุ่น `2026-07-18.5` เพิ่มข้อความตามระยะและ Test Admin role พร้อมรองรับโซนออนไลน์ครบ 4 โลก และคงการตรวจ `bossHp` เทียบกับ `bossMax` ของข้อมูลหลังเขียน (`newData`)
